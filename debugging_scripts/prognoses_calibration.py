...
project_name = "prognoses_calibration_test"
...
calib_pars = dict(
    prognoses = dict(
        flock = dict(
                breeds = np.array(['duck', 'broiler', 'layer'], dtype=zn.default_str),
                sus_ORs = [np.array([1.00, 1.00, 1.00]), np.array([0.00, 0.00, 0.00]), np.array([10.00, 10.00, 10.00])],
                trans_ORs = [np.array([1.00, 1.00, 1.00]), np.array([0.00, 0.00, 0.00]), np.array([10.00, 10.00, 10.00])]
        )
    )
)

calib = zn.Calibration(sim, calib_pars, name = project_name, n_trials=5, die=True, keep_db=True)
