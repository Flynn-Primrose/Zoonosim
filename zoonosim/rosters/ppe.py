...
class PPE(Subroster):
    ...
    **Examples**::
    ...
    def set_rel_trans(self):
        ...
        if self.pars['transmission_pars']['ppe']['beta_dist'] is not None:
            self.rel_trans = self.rel_trans * znu.sample(**self.pars['transmission_pars']['ppe']['beta_dist'], size = len(self))
        return
