...
__all__ = ['default_float', 'default_int', 'default_str', 'nbfloat', 'nbint', 'get_default_colors']
...
default_flock_prognoses = dict(
    ...
    infected_symptomatic_rate = np.array([dict(dist='lognormal', par1 = 0.5, par2 = 0.15),
                                          dict(dist='lognormal', par1=0.3, par2 = 0.15),
                                          dict(dist='lognormal', par1=0.7, par2=0.15)]),
