'''
This comes untouched from Covasim. FlexPretty just provides a nicer way to display internal objects.
obj.brief() will print a one-line description of the object, while obj.disp() will print a full description.
'''
