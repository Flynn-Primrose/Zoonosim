...
default_breed_mortality_rates = [0.001, 0.001, 0.001] # Mortality rates for the different breeds
default_breed_symp_rates = [0.001, 0.001, 0.001] # Symptomatic rates for the different breeds
