...
best_sim = zn.Sim(datafile="zoonosim/data/H5N1_cases_in_QC_poultry.csv", label = "Calibration2_1_best3", pars=best_pars, recursive = False)

msim = zn.MultiSim(best_sim, n_runs = 25, verbose = 0)  # Wrap the simulation in a MultiSim object.

if __name__ == "__main__":
    msim.run()                    # Run the simulations.
    msim.save('msims/calibration2_1_best3.msim')  # Save the multi-simulation object.
