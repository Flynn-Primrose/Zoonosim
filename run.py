'''
Functions and classes for running multiple Zoonosim runs.
'''
...
class MultiSim(znb.FlexPretty):
    ...
    **Examples**::
    ...
    def __init__(self, sims=None, base_sim=None, label=None, initialize=False, **kwargs):
        ...
        znb.set_metadata(self) # Set version, date, and git info
        ...
        **Example**::
        ...
        for s,sim in enumerate(self.sims[1:]): # Skip the first one
            if combined_sim.people: # If the people are there, add them and increment the population size accordingly
                combined_sim.people += sim.people # NOTE: Addition of 
        ...
        **Examples**::
        ...
        # PLot individual sims on top of each other
            ...
            if to_plot is None:
                ...
                to_plot = znd.get_default_plots(kind=kind)
            ...
            for s,ind in enumerate(inds):
                ...
                if final_plot:
                    ...
                    zno.set(close=orig_close) # Reset original closing settings
                else:
                    ...
                    zno.set(close=False) # Do not close figures if we're in the middle of plotting
    ...
    def plot_compare(self, t=-1, sim_inds=None, log_scale=True, **kwargs):
        ...
        return znpl.plot_compare(df, log_scale=log_scale, **kwargs)
    ...
    def save(self, filename=None, keep_people=False, **kwargs):
        ...
        **Example**::
        ...
        znm.save(filename=msimfile, obj=obj) # Actually save
    ...
    def load(msimfile, *args, **kwargs):
        ...
        **Example**::
        ...
        '''
        msim = znm.load(msimfile, *args, **kwargs)
    ...
    **Example**::
    ...
    def __init__(self, sim=None, metapars=None, scenarios=None, basepars=None, scenfile=None, label=None):
        ...
        if scenfile is None:
            ...
            scenfile = f'zoonosim_scenarios_{datestr}.scens'
    ...
    def plot(self, *args, **kwargs):
        ...
        **Example**::
            ...
            scens.plot()
        '''
        return znpl.plot_scens(scens=self, *args, **kwargs)
    ...
    def save(self, scenfile=None, keep_sims=True, keep_people=False, **kwargs):
        ...
        **Example**::
        ...
        znm.save(filename=scenfile, obj=obj) # Actually save
    ...
    def load(scenfile, *args, **kwargs):
        ...
        **Example**::
            ...
            scens = zn.Scenarios.load('my-scenarios.scens')
        '''
        scens = znm.load(scenfile, *args, **kwargs)
    ...
    def disp(self, output=False):
        ...
        **Example**::
            ...
            scens = zn.Scenarios(zn.Sim(), label='Example scenarios')
