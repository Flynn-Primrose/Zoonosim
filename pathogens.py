...
class SARS_COV_2(Pathogen):
    ...
    def make_default_pathogen_pars(self):
        ...
        self.dur['asym2rec'] = dict(dist='lognormal_int', par1=8.0,  par2=2.0) # Duration for asymptomatic people to recover; see W�lfel et al., https://www.nature.com/articles/s41586-020-2196-x
        self.dur['mild2rec'] = dict(dist='lognormal_int', par1=8.0,  par2=2.0) # Duration for people with mild symptoms to recover; see W�lfel et al., https://www.nature.com/articles/s41586-020-2196-x
